            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="color: #32AC63;">Surat Rujukan</h3>
                    </div>
                        ...
                        <div style="border: 2px solid #32AC63; border-radius: 5px;height: auto; background-color: white;">
                            ...
                            <div class="row" style="margin-top:20px; padding: 10px 20px; line-height: 20px;">
                                ...
                                @foreach($dataSurat as $index => $dps)
                                    <p style="margin-top: -10px;margin-bottom: 20px; font-size: 15px; font-weight: bold;text-transform: uppercase;">No. {{$dps->no_surat}}/RSIA-B/2019</p>
                                </div>
