                                                ...
                                                <table id="data-pemeriksaan" class="table table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$pas->keluhan}}</td>
                                                            <td>
                                                                <a href="/pemeriksaanPetugasPenunjang/periksa/{{ $pas->no_rekam_medis }}" class="btn btn-info btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i> Buat Pemeriksaan Penunjang</a>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
