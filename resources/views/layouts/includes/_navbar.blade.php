            ...
            <div class="topbar-main  navbar m-b-0 b-0">
                <div class="container">
                    ...
                    <div class="topbar-left">
                        <a href="{{url('/dashboard')}}" class="logo"><!-- <i class="md md-local-hospital"></i> --> <span> RSIA Bahagia  </span></a>
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            <li class="dropdown user-box">
                                <a href="#" class="dropdown-toggle waves-effect waves-light profile " data-toggle="dropdown" aria-expanded="true">
                                    ...
                                    <div class="user-status away"><i class="md md-person"></i><span style="margin-right: 5px;margin-left: 5px;">{{ Auth::user()->nama }}</span><i class="md md-keyboard-arrow-down"></i></div>
                                </a>
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li class="{{ (request()->is('dashboard')) ? 'active' : '' }}">
                                <a href="{{url('/dashboard')}}"><i class="ion ion-pie-graph"></i> <span> Dashboard Admin </span> </a>
                            </li>
